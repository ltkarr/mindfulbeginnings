...
3. Under app settings, add your live domains, e.g.:
   - `https://register.mindfulbeginnings.org` (public registration / payment host)
   - `https://mindfulbeginnings.vercel.app` (legacy; `vercel.json` permanently redirects HTML pages to the custom domain)
...
5. (Recommended) Add a webhook:
   - URL: `https://register.mindfulbeginnings.org/api/paypal/webhook`
